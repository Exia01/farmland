...
export default function CurrentThemeProvider(props) {
  ...
  const { mode } = themePreference.palette;
  const theme = createTheme({
    palette: {
      mode: themePreference.palette.mode,
      primary: {
        // main: '#f7f7f7',
        main: mode === 'light' ? '#48680e' : '#add370',
        // light: 'rgb(111, 191, 115)',
        // dark: 'rgb(53, 122, 56)',
        // contrastText: 'rgba(0, 0, 0, 0.87)',
      },
      secondary: {
        main: mode === 'light' ? '#596249' : '#c1caac',
        //   // light: 'rgb(255, 167, 51)',
        //   // dark: 'rgb(178, 101, 0)',
        //   // contrastText: 'rgba(0, 0, 0, 0.87)',
      },
      tertiary: {
        main: mode === 'light' ? '#386661' : '#a0d0ca',
      },
      neutral: {
        main: mode === 'light' ? '#75786c' : '#8f9285',
      },
      divider: {
        main: mode === 'light' ? '#ebebeb' : '#272824',
      },
