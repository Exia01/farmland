const data = [
  ...
  },
  {
    ...
    productVariants: [],
    name: 'Strawberries',
    description: 'Farm fresh. Local when available',
    listed: 'true',
    price: '6.99',
  },
  {
    ...
    productVariants: [],
    name: 'Blueberries',
    description: 'Blueberries are a delicious snack for the entire family, any time of day. Enjoy them sprinkled over cereal, oatmeal or granola as part of a healthy breakfast. ',
    listed: 'true',
    price: '9.99',
  },
  {
